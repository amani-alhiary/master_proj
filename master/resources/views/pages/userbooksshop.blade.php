            	...
            	<div class="col-12 col-sm-12 col-md-3 col-lg-3 sidebar filterbar">
                	...
                	<div class="sidebar_tags">
                            ...
                            <div class="widget-content">
                                <ul class="sidebar_categories">
                                    ...
                                    <li class="level1 sub-level"><a href="#;" class="site-nav">Fliter by Category</a>
                                    	<ul class="sublinks">
                                            @foreach ($categories as $category)
                                            <form action="{{ route('categoryusedbooksfilter.index') }}" method="GET">
                        ...
                        <div class="sidebar_widget filterBox filter-widget">
                            ...
                            <form action="{{ route('categoryusedbooksfilter.store') }}"  method="post" class="price-filter" enctype="multipart/form-data">
                                @csrf
                                  ...
                                  <div class="grid">
                                    ...
                                    <div class="grid__item">
                                      <div class="mini-list-item">
                                        ...
                                        <div class="details"> <a class="grid-view-item__title" href="{{ url('userbooksdetails?id=' . $rendombook['id']) }}">{{ $rendombook->book_name }}</a>
                                            <br>
                        	...
                        	<div class="filters-toolbar-wrapper">
                            	<div class="row">
                                    ...
                                    <div class="col-4 col-md-4 col-lg-4 text-center filters-toolbar__item filters-toolbar__item--count d-flex justify-content-center align-items-center">
                                    	<span class="filters-toolbar__product-count">Used Books</span>
                                    </div>
...
<div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
    ...
    <div class="product-image">
        ...
        <a  href="{{ url('userbooksdetails?id=' . $book['id']) }}" >
            ...
            <!-- End image -->
            <img class="hover blur-up lazyload" data-src="usersimg/image_01/{{ $book->image_01 }}" src="usersimg/image_01/{{ $book->image_01 }}" alt="image" title="product" style="height:350px">
            <!-- End hover image -->
            <!-- product label -->
            <div class="product-labels rectangular">
            @if ($book->price!=$book->sale_price)

          <span class="lbl on-sale">-{{number_format((($book->sale_price-$book->price)/$book->price)*100) }}%</span>
            <!-- End product label -->
            @endif
            <span class="lbl pr-label1">Used</span>
        </div>
        </a>
        <!-- end product image -->
        ...
        <div class="button-set">
            <a  href="{{ url('userbooksdetails?id=' . $book['id']) }}" class="quick-view-popup quick-view">
                    ...
                    <form method="POST" action="{{ route('useraddtocart') }}">
                        @csrf
