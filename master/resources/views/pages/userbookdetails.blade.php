        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    ...
                    <form action="{{ route('authorbooksfilter.index') }}" method="GET">
                        ...
                        <div  data-user="23" data-time="24" style="margin-bottom:3vh;">
                            
                            Published by:
                            <a href="{{ url('otherprofile?id=' .$book[0]->user_id )}}">
                            <img src="usersimg/image/{{ $user[0]->image }}" alt="" style="width: 50px;height:50px;border-radius: 50%;"/> <strong class="items">{{ $user[0]->name }}</strong></a> </div>
                        <!-- Product Action -->
                            ...
                            <div class="display-table-cell medium-up--one-third">
                                <div class="wishlist-btn">
                                    ...
                                    @if ($favourites->isNotEmpty()) 
                                     ...
                                     @else
                                    <form action="{{ route('addtofavouriteusedbooks.store') }}"  method="post" class="price-filter" enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" name="user_book_id" value="{{ $book[0]->id }}">
        ...
        <div class="productPageSlider">
            ...
            <div class="col-12 item" >
                ...
                <div class="product-image">
                    <!-- start product image -->
                    <a  href="{{ url('userbooksdetails?id=' . $realtedbook['id']) }}" >
                        <!-- image -->
                    ...
                    <div class="button-set">
                        <a  href="{{ url('userbooksdetails?id=' . $realtedbook['id']) }}" class="wishlist add-to-wishlist">
