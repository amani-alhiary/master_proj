                    ...
                    <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                        ...
                        <div class="product-image">
                            ...
                            <!-- Start product button -->
                                    ...
                                    <form method="GET" action="{{ route('showresultbookdetails') }}" class="variants add">
                                        @csrf
                                ...
                                <button class="btn btn-addto-cart" type="submit">See Details</button>
                        </form>
                        ...
                        <div class="product-details text-center">
                            ...
                            <div class="product-name">
                                <form method="GET" action="{{ route('showresultbookdetails') }}" >
                                    @csrf
                            ...
                            <button  type="submit" style="cursor: pointer;border:none">{{ $book->book_name }}
                            </button>
                        </a>
                    </form>
