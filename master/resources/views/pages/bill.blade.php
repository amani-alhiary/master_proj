...
<div class="container mt-5 mb-5">
    ...
    <h5>Your order Confirmed!</h5> <span class="font-weight-bold d-block mt-4">Hello, {{ Auth::user()->name }}</span> <span>Your order has been confirmed and will be shipped in next two days!</span>
    ...
    <td>
    <div class="py-2"> <span class="d-block text-muted">Country</span> <span>{{ $order->country }}</span> </div>
    </td>
    <td>
    ...
    <p class="font-weight-bold mb-0">Thanks for shopping with us!</p> <span>Book Store Team</span>
    </div>
